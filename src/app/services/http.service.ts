...
export class HttpService {
  ...
  constructor(  public _http: HttpClient) { 
    this.url = "https://accounts.spotify.com/en/authorize?client_id=1d449aa39a5745a9b8cb38b6f69d7052&redirect_uri=https://spotify-app.netlify.com/home&response_type=token";
